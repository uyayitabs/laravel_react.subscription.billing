...
import RelationForm from "../modals/RelationForm";
...
class TableRelations extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return(
      <Container fluid className="p-0">
        <h1 className="h3 mb-3">Relations</h1>
        ...
        <RelationForm show={ this.state.isOpen } hide={ this.toggleModal } />
      </Container>
    )
  }
}
