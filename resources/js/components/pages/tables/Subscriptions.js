...
import SubscriptionForm from "../modals/SubscriptionForm";
...
class TableSubscriptions extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return(
      <Container fluid className="p-0">
        <h1 className="h3 mb-3">Subscriptions</h1>
        ...
        <SubscriptionForm show={ this.state.isOpen } hide={ this.toggleModal } />
      </Container>
    )
  }
}
