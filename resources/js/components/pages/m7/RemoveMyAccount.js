...
class RemoveMyAccount extends React.Component {
    constructor(props) {
        super(props);
    ...
    async handleSubmit(e) {
        ...
        M7Call('RemoveMyAccount', this.state.data).then((res) => {
            let { data } = res;
    ...
    render() {
        return (
            <React.Fragment>
                <CardHeader>
                    <h4 className="mb-0">Remove My Account</h4>
                </CardHeader>
                <CardBody>
...
export default RemoveMyAccount;
