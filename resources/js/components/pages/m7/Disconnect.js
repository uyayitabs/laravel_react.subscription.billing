...
class Disconnect extends React.Component {
    ...
    async handleSubmit(e) {
        ...
        M7Call('Disconnect', this.state.data).then((res) => {
            let { data } = res;
    ...
    render() {
        return (
            <React.Fragment>
                <CardHeader>
                    <h4 className="mb-0">Disconnect</h4>
                </CardHeader>
                <CardBody>
                        ...
                        <FormGroup className="row">
                            <div className="col-12 col-md-3 mb-2">
                                ...
                                <Input
                                    ...
                                    type="text"
                                    name="CustomerNumber"
                                    value={this.state.data.Disconnect.CustomerNumber}
                                    onChange={(e) => this.handleChange('Disconnect', e)}
                                />
                            </div>
                            <div className="col-12 col-md-3 mb-2">
                                ...
                                <Input
                                    ...
                                    type="text"
                                    name="ContractNumber"
                                    value={this.state.data.Disconnect.ContractNumber}
                                    onChange={(e) => this.handleChange('Disconnect', e)}
                                />
                            </div>
                            <div className="col-12 col-md-3 mb-2">
                                ...
                                <Input
                                    ...
                                    value={this.state.data.Disconnect.Smartcardnumber}
                                    onChange={(e) => this.handleChange('Disconnect', e)}
                                />
